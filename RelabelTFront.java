...
public class RelabelTFront {
	

		private FlowNetwork fn;
		private final int INF = 1999999999;
		public RelabelTFront(FlowNetwork flownetwork){
			fn = flownetwork;
		...
		public int push(FlowNetwork fn, int from, int to){
		...
		public void relabel(FlowNetwork fn, int target){
			int minH = INF;
		...
		public int[] discharge(FlowNetwork fn, int target, int[] currents){
		...
		public int[] moveIndToFrontOfAry(int[] list, int targetInd){
